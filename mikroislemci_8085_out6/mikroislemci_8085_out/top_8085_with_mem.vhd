...
architecture rtl of top_8085_with_mem is
    -- ** COMPONENT TANIMLARI **
	 component clk_divider_1mhz -- YENI EKLEME
        port (
            clk_in    : in  std_logic;              
...
begin
    ...
    A_full <= add_bus & a_low_latched;  -- A15..A0
	 ...
	 clk_div_i : entity work.clk_divider_1mhz
        port map(
            clk_in    => clk,
            reset_n   => reset_n,
            clk_out   => cpu_clk_1mhz -- 3 MHz olarak kullanılacak
        );
